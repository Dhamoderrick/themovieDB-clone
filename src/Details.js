...
function Details(props) {
  ...
  useEffect(() => {
    async function fetchData() {
      const appendvalue = `${request.fetchMovieDetails}${movieid}${request.api}`;
      const credit = `${request.fetchMovieDetails}${movieid}${request.credits}`;
      const keywords = `${request.fetchMovieDetails}${movieid}${request.keywords}`;
      const trailer = `${request.fetchMovieDetails}${movieid}${request.fetchMovieTrailer}`;
      ...
      setkey(movie_key.data.keywords);
